...
<div class="heading" style = "background: url(book-background.jpg) no-repeat">
    <h1>Book Us</h1>
</div>
...
<section class="booking">
    ...
    <form action="book_form.php" method="post" class="book-form">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>phone :</span>
                <input type="number" placeholder="enter you phone number " name="phone">
            </div>
            <div class="inputBox">
                <span>addres :</span>
            ...
            <div class="inputBox">
                ...
                <input type="date" placeholder="date" name="arraivals">
            </div>
            <div class="inputBox">
                <span>leaving time:</span>
                <input type="date" placeholder="date" name="leaving">
            </div>
